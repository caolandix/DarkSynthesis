...
public:
    ...
    PhysVectorDataObj(const QString, const QString, const QString = "", const double = 0.0, const double = 0.0, const double = 0.0);
    PhysVectorDataObj(const QString, const QStringList, const QString = "", const double = 0.0, const double = 0.0, const double = 0.0);
