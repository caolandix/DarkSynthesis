...
public:
    ...
    CustomOperatorAdd(const string symbol, const int precedence) : CustomOperator(symbol, precedence) {}
    CustomOperatorAdd(const string symbol) : CustomOperator(symbol) {}
